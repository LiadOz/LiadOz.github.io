...
function showProps(){
    ...
    st+= '<a href="#avcalendarsSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle list-group-item bg-light">Add Calendar</a>'
    ...
    st+= '<a href="#avlocationsSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle list-group-item bg-light">Add Location</a>'
